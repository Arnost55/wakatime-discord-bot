...
if (!apiKey) {
  throw new Error('OPENAI\_API\_KEY not configured')
}
```
...
Validation: Before finishing a task, verify that the implementation aligns with the protocols in AGENTS.md and after that you do the git thing below.
